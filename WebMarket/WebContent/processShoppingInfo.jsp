...
<%
	...
	cartId.setMaxAge(14 * 60 * 60);
	name.setMaxAge(14 * 60 * 60);
	shoppingDate.setMaxAge(14 * 60 * 60);
	country.setMaxAge(14 * 60 * 60);
	zipCode.setMaxAge(14 * 60 * 60);
	addressName.setMaxAge(14 * 60 * 60);
